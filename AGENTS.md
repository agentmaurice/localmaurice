...
Runtime edge / capability bridge (publication GitHub).
Article de référence : `wiki/projects/localmaurice.md` dans pilote-maurice.
...
|-------|-----------------------------------|
| Comprendre le dépôt avant d'éditer | `wiki/INDEX.md` puis `wiki/projects/localmaurice.md` |
